...
const init = () => {
  ...
  document.getElementById("stopAndStartGame").addEventListener("click", () => game.infinityEgg());
  document.getElementById("stopAndStartGame").addEventListener("click", () => game.infinityRocket());
